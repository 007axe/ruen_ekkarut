<template>
    ...
    class="fixed flex w-full  border-b items-center justify-between flex-wrap p-2 m-auto top-0 animated"> 
        <div class="container mx-auto flex justify-between items-center md:h-14">
            <div >
                ...
                <ul class="md:flex md:items-center text-center md:px-0 px-10 md:pb-0 pb-10 md:static absolute bg-white dark:bg-black md:w-auto w-full h-25 md:py-0 py-10 top-14 duration-700 ease-in"
